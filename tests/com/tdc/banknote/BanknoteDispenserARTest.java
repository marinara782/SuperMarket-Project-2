...
public class BanknoteDispenserARTest {
	...
	public void testEject()
		throws DisabledException, NoCashAvailableException, SimulationException, CashOverloadException {
		Banknote banknote = new Banknote(currency, BigDecimal.ONE);
		dispenser.load(banknote);
		dispenser.attach(new BanknoteDispenserObserver() {
			@Override
	...
	@Test(expected = NoPowerException.class)
	public void testReceiveNoPower() throws CashOverloadException, DisabledException {
		dispenser.disconnect();
		dispenser.receive(banknote);
	}

	@Test
	public void testReceive() throws CashOverloadException, DisabledException {
		dispenser.receive(banknote);
	}
	...
	public void testBadReceive() throws CashOverloadException, DisabledException {
		dispenser.receive(null);
	}

	@Test(expected = DisabledException.class)
	public void testReceiveWhileDisabled() throws CashOverloadException, DisabledException {
		dispenser.disable();
		dispenser.receive(banknote);
	}

	@Test(expected = NoPowerException.class)
	public void testHasSpaceNoPower() throws CashOverloadException, DisabledException {
		dispenser.disconnect();
		dispenser.hasSpace();
	}
}
