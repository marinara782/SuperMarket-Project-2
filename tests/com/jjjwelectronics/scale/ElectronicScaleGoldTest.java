...
public class ElectronicScaleGoldTest {
	private ElectronicScaleGold scale;
	...
	public void setup() {
		...
		heavyItem = new BarcodedItem(new Barcode(convert("0")), new Mass(new BigInteger("200000000000")));
		normalItem = new BarcodedItem(new Barcode(convert("0")), new Mass(new BigInteger("20000000000")));
	...
	public void testMass() throws OverloadedDevice {
		assertEquals(new Mass(new BigInteger("100000000000")), scale.getMassLimit());
		...
		assertEquals(new Mass(BigInteger.valueOf(100_000)), scale.getSensitivityLimit());
	}
