...
public class ElectronicScaleBronzeTest {
	...
	public void setup() {
		...
		normalItem = new BarcodedItem(new Barcode(convert("0")), new Mass(new BigInteger("500000000")));
		lightItem = new BarcodedItem(new Barcode(convert("0")), new Mass(new BigInteger("2000000")));
		found = 0;
	...
	public void testMass() throws OverloadedDevice {
		assertEquals(new Mass(new BigInteger("1000000000")), scale.getMassLimit());
		...
		assertEquals(new Mass(BigInteger.valueOf(5_000_000)), scale.getSensitivityLimit());
	}
