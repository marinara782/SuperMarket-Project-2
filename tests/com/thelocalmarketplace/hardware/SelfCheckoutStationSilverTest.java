...
public class SelfCheckoutStationSilverTest {
	private SelfCheckoutStationSilver station;
	...
	public void testBadConfigureBanknoteDenominations() {
		SelfCheckoutStationSilver.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ONE, BigDecimal.ONE });
	}

	@Test
	public void testConfigureReusableBagsDispenser() {
		SelfCheckoutStationSilver.configureReusableBagDispenserCapacity(1);
		station = new SelfCheckoutStationSilver();
	...
	public void testBadConfigureReusableBagsDispenser() {
		SelfCheckoutStationSilver.configureReusableBagDispenserCapacity(0);
	}

	@Test
	public void testConfigureCoinDispenser() {
		SelfCheckoutStationSilver.configureCoinDispenserCapacity(1);
		station = new SelfCheckoutStationSilver();
	...
	public void testBadConfigureCoinDispenser() {
		SelfCheckoutStationSilver.configureCoinDispenserCapacity(0);
	}

	@Test
	public void testConfigureBanknoteStorageUnit() {
		SelfCheckoutStationSilver.configureBanknoteStorageUnitCapacity(1);
		station = new SelfCheckoutStationSilver();
	...
	public void testBadConfigureBanknoteStorageUnit() {
		SelfCheckoutStationSilver.configureBanknoteStorageUnitCapacity(0);
	}

	@Test
	public void testConfigureCoinStorageUnit() {
		SelfCheckoutStationSilver.configureCoinStorageUnitCapacity(1);
		station = new SelfCheckoutStationSilver();
	...
	public void testBadConfigureCoinStorageUnit() {
		SelfCheckoutStationSilver.configureCoinStorageUnitCapacity(0);
	}

	@Test
	public void testConfigureCoinTray() {
		SelfCheckoutStationSilver.configureCoinTrayCapacity(1);
		station = new SelfCheckoutStationSilver();
		assertEquals(1, station.coinStorage.getCapacity());
	}
	...
	public void testBadConfigureCoinTray() {
		SelfCheckoutStationSilver.configureCoinTrayCapacity(0);
	}

	@Test(expected = InvalidArgumentSimulationException.class)
	public void testBadConfigureCoinDenominations() {
		SelfCheckoutStationSilver.configureCoinDenominations(new BigDecimal[] { BigDecimal.ZERO });
	}

	@Test(expected = InvalidArgumentSimulationException.class)
	public void testBadConfigureCoinDenominations2() {
		SelfCheckoutStationSilver.configureCoinDenominations(new BigDecimal[] { BigDecimal.ONE, BigDecimal.ONE });
	}

	@Test
	public void testSimple() {
		SelfCheckoutStationSilver.configureCurrency(CAD);
		SelfCheckoutStationSilver.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ONE });
		SelfCheckoutStationSilver.configureCoinDenominations(new BigDecimal[] { BigDecimal.ONE });
		SelfCheckoutStationSilver.configureScaleMaximumWeight(2.0);
		SelfCheckoutStationSilver.configureScaleSensitivity(1.0);
		station = new SelfCheckoutStationSilver();
	}

	@Test(expected = SimulationException.class)
	public void testBad() {
		SelfCheckoutStationSilver.configureCurrency(null);
	}

	@Test(expected = SimulationException.class)
	public void testBad2() {
		SelfCheckoutStationSilver.configureBanknoteDenominations(new BigDecimal[0]);
	}

	@Test(expected = SimulationException.class)
	public void testBad3() {
		SelfCheckoutStationSilver.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ZERO });
	}

	@Test(expected = SimulationException.class)
	public void testBad4() {
		SelfCheckoutStationSilver.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ONE, BigDecimal.ZERO });
	}

	@Test(expected = SimulationException.class)
	public void testBad5() {
		SelfCheckoutStationSilver.configureCoinDenominations(null);
	}

	@Test(expected = SimulationException.class)
	public void testBad6() {
		SelfCheckoutStationSilver.configureCoinDenominations(new BigDecimal[] {});
	}

	@Test(expected = SimulationException.class)
	public void testBad8() {
		SelfCheckoutStationSilver.configureScaleMaximumWeight(0);
	}

	@Test(expected = SimulationException.class)
	public void testBad9() {
		SelfCheckoutStationSilver.configureScaleSensitivity(0);
	}

	@Test(expected = SimulationException.class)
	public void testBad10() {
		SelfCheckoutStationSilver.configureBanknoteDenominations(null);
	}
	...
	public void testInsertBadBanknote() throws DisabledException, CashOverloadException {
		...
		SelfCheckoutStationSilver.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ONE });
		SelfCheckoutStationSilver.configureCoinDenominations(new BigDecimal[] { BigDecimal.ONE });
		SelfCheckoutStationSilver.configureScaleMaximumWeight(10.0);
		SelfCheckoutStationSilver.configureScaleSensitivity(1.0);
	...
	public void testInsertGoodCoin() throws DisabledException, CashOverloadException, NoCashAvailableException {
		SelfCheckoutStationSilver.configureCurrency(CAD);
		SelfCheckoutStationSilver
			.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ONE, BigDecimal.valueOf(2) });
		SelfCheckoutStationSilver.configureCoinDenominations(new BigDecimal[] { BigDecimal.TEN, BigDecimal.ONE });
		SelfCheckoutStationSilver.configureScaleMaximumWeight(10.0);
		SelfCheckoutStationSilver.configureScaleSensitivity(2.0);
