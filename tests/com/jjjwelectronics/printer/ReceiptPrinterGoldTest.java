...
public class ReceiptPrinterGoldTest {
	private ReceiptPrinterGold printer;
	private int found;

	@Before
	public void setup() throws OverloadedDevice {
		printer = new ReceiptPrinterGold();
		PowerGrid.engageUninterruptiblePowerSource();
		PowerGrid.instance().forcePowerRestore();
		printer.plugIn(PowerGrid.instance());
		printer.turnOn();
		printer.addPaper(2);
		printer.addInk(ReceiptPrinterGold.CHARACTERS_PER_LINE);
		found = 0;
	}
	...
	public void testPaperRemaining() {
		assertEquals(2, printer.paperRemaining());
	}

	@Test
	public void testInkRemaining() {
		assertEquals(ReceiptPrinterGold.CHARACTERS_PER_LINE, printer.inkRemaining());
	}
	...
	public void testPrintFullLine() throws EmptyDevice, OverloadedDevice {
		...
		for(int i = 0; i < ReceiptPrinterGold.CHARACTERS_PER_LINE; i++)
			printer.print('a');
	...
	@Test
	public void testPrintNotLow() throws OverloadedDevice, EmptyDevice {
		printer = new ReceiptPrinterGold();
		printer.plugIn(PowerGrid.instance());
		printer.turnOn();
		printer.addInk(ReceiptPrinterGold.MAXIMUM_INK);
		printer.addPaper(ReceiptPrinterGold.MAXIMUM_PAPER);
	...
	public void testAddTooMuchInk() throws OverloadedDevice, EmptyDevice {
		printer.addInk(ReceiptPrinterGold.MAXIMUM_INK + 1);
	}
	...
	public void testAddTooMuchPaper() throws OverloadedDevice, EmptyDevice {
		printer.addPaper(ReceiptPrinterGold.MAXIMUM_PAPER + 1);
	}
