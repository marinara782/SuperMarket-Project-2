...
public class ReusableBagDispenserSilverTest {
	ReusableBagDispenserSilver dispenser;
	ReusableBag bag;
	int found;
	int count;
	...
	public void setup() {
		...
		count = 0;
		bag = new ReusableBag();
		dispenser = new ReusableBagDispenserSilver(2);
	...
	public void testBadCreate() {
		new ReusableBagDispenserSilver(0);
	}
