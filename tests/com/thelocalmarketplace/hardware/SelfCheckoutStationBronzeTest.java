...
public class SelfCheckoutStationBronzeTest {
	...
	public void testConfigureReusableBagsDispenser() {
		SelfCheckoutStationBronze.configureReusableBagDispenserCapacity(1);
		station = new SelfCheckoutStationBronze();
	...
	public void testBadConfigureReusableBagsDispenser() {
		SelfCheckoutStationBronze.configureReusableBagDispenserCapacity(0);
	}

	@Test
	public void testConfigureCoinDispenser() {
		SelfCheckoutStationBronze.configureCoinDispenserCapacity(1);
		station = new SelfCheckoutStationBronze();
	...
	public void testBadConfigureCoinDispenser() {
		SelfCheckoutStationBronze.configureCoinDispenserCapacity(0);
	}

	@Test
	public void testConfigureBanknoteStorageUnit() {
		SelfCheckoutStationBronze.configureBanknoteStorageUnitCapacity(1);
		station = new SelfCheckoutStationBronze();
	...
	public void testBadConfigureBanknoteStorageUnit() {
		SelfCheckoutStationBronze.configureBanknoteStorageUnitCapacity(0);
	}

	@Test
	public void testConfigureCoinStorageUnit() {
		SelfCheckoutStationBronze.configureCoinStorageUnitCapacity(1);
		station = new SelfCheckoutStationBronze();
	...
	public void testBadConfigureCoinStorageUnit() {
		SelfCheckoutStationBronze.configureCoinStorageUnitCapacity(0);
	}
//
//	@Test
//	public void testConfigureCoinTray() {
//		SelfCheckoutStationBronze.configureCoinTrayCapacity(1);
//		station = new SelfCheckoutStationBronze();
...
//	}
	...
	public void testBadConfigureCoinTray() {
		SelfCheckoutStationBronze.configureCoinTrayCapacity(0);
	}

	@Test(expected = InvalidArgumentSimulationException.class)
	public void testBadConfigureCoinDenominations() {
		SelfCheckoutStationBronze.configureCoinDenominations(new BigDecimal[] { BigDecimal.ZERO });
	}

	@Test(expected = InvalidArgumentSimulationException.class)
	public void testBadConfigureCoinDenominations2() {
		SelfCheckoutStationBronze.configureCoinDenominations(new BigDecimal[] { BigDecimal.ONE, BigDecimal.ONE });
	}
	...
	public void testSimple() {
		...
		SelfCheckoutStationBronze.configureScaleMaximumWeight(2.0);
	...
	public void testBad() {
		SelfCheckoutStationBronze.configureCurrency(null);
	}

	@Test(expected = SimulationException.class)
	public void testBad2() {
		SelfCheckoutStationBronze.configureBanknoteDenominations(new BigDecimal[0]);
	}

	@Test(expected = SimulationException.class)
	public void testBad3() {
		SelfCheckoutStationBronze.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ZERO });
	}

	@Test(expected = SimulationException.class)
	public void testBad4() {
		SelfCheckoutStationBronze.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ONE, BigDecimal.ZERO });
	}

	@Test(expected = SimulationException.class)
	public void testBad5() {
		SelfCheckoutStationBronze.configureCoinDenominations(null);
	}

	@Test(expected = SimulationException.class)
	public void testBad6() {
		SelfCheckoutStationBronze.configureCoinDenominations(new BigDecimal[] {});
	}

	@Test(expected = SimulationException.class)
	public void testBad8() {
		SelfCheckoutStationBronze.configureScaleMaximumWeight(0);
	}

	@Test(expected = SimulationException.class)
	public void testBad9() {
		SelfCheckoutStationBronze.configureScaleSensitivity(0);
	}

	@Test(expected = SimulationException.class)
	public void testBad10() {
		SelfCheckoutStationBronze.configureBanknoteDenominations(null);
	}
	...
	public void testInsertGoodCoin() throws DisabledException, CashOverloadException, NoCashAvailableException {
		SelfCheckoutStationBronze.configureCurrency(CAD);
		SelfCheckoutStationBronze
			.configureBanknoteDenominations(new BigDecimal[] { BigDecimal.ONE, BigDecimal.valueOf(2) });
		SelfCheckoutStationBronze.configureCoinDenominations(new BigDecimal[] { BigDecimal.TEN, BigDecimal.ONE });
		SelfCheckoutStationBronze.configureScaleMaximumWeight(10.0);
		SelfCheckoutStationBronze.configureScaleSensitivity(2.0);
		...
		station.coinStorage.attach(new CoinStorageUnitObserver() {
			@Override
			public void coinsUnloaded(CoinStorageUnit storage) {
				fail();
			}

			@Override
			public void coinsLoaded(CoinStorageUnit storage) {
				fail();
			}

			@Override
			public void coinsFull(CoinStorageUnit storage) {
				fail();
			}

			@Override
			public void coinAdded(CoinStorageUnit storage) {
				coinAdded++;
			}
